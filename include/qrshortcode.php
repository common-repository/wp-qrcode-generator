...
*   ShortCode 
*/
function wpqr_shortcode( $attributes ){
    $ht_id = uniqid();
    ...
    ob_start();
        echo sprintf('
            <div class="wp_qrcode-%1$s" style="text-align:%2$s">
            </div>
        ...
        <script type="text/javascript">
        	jQuery(document).ready(function($) {
	            ...
	            new QRCode(document.querySelector(".wp_qrcode-%1$s"),{
	                text: `%6$s`,
	                width: %7$s,
	                height: %7$s,
	                dotScale: %8$s,
	                correctLevel: QRCode.CorrectLevel.%9$s,
	                logo: "%10$s",
	                logoWidth:%11$s, 
	                logoHeight:%11$s,
...
add_shortcode( 'qrcodewp', 'wpqr_shortcode');